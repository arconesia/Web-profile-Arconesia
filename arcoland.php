...
<main id="arcoland">
  <!-- Hero -->
  <section class="relative h-[40vh] min-h-[320px] bg-cover bg-center text-white" style="background-image:linear-gradient(rgba(0,0,0,.4),rgba(0,0,0,.4)),url('assets/img/banner/banner-arcoland.png')">
      ...
      <div>
        ...
        <div class="relative overflow-hidden">
          <div class="flex gap-8 animate-scroll-x will-change-transform">
            ...
            <div class="bg-gray-100 rounded-2xl p-8 w-[400px] shrink-0">
              <div class="flex items-center gap-4 mb-6">
                <img class="w-14 h-14 rounded-full object-cover" src="assets/img/petani-2.png" alt="Ibu Siti" />
                <div>
            ...
            <div class="bg-gray-100 rounded-2xl p-8 w-[400px] shrink-0">
              <div class="flex items-center gap-4 mb-6">
                <img class="w-14 h-14 rounded-full object-cover" src="assets/img/petani-pp.png" alt="Bapak Budi" />
                <div>
