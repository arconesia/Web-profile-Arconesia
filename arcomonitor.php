...
<main id="arcomonitor">
  <!-- Hero -->
  <section class="relative h-[40vh] min-h-[320px] bg-cover bg-center text-white" style="background-image:linear-gradient(rgba(0,0,0,.4),rgba(0,0,0,.4)),url('assets/img/banner/banner-arcomonitor.png')">
    <div class="max-w-[1160px] mx-auto px-4 h-full flex flex-col justify-center">
      <h1 class="text-5xl md:text-6xl font-extrabold">ArcoMonitor</h1>
      <p class="text-xl text-white/90">Platform manajemen pertanian berbasis data untuk keputusan yang lebih cerdas.</p>
    </div>
  </section>
